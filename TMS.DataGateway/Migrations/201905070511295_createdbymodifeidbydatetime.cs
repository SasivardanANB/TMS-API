namespace TMS.DataGateway.Migrations
{
    ...
    public partial class createdbymodifeidbydatetime : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("TMS.Partner", "CreatedBy", c => c.String(defaultValue: "SYSTEM"));
            AddColumn("TMS.Partner", "CreatedTime", c => c.DateTime(nullable: false, defaultValueSql: "GETDATE()"));
            AddColumn("TMS.Partner", "LastModifiedBy", c => c.String());
            AddColumn("TMS.Partner", "LastModifiedTime", c => c.DateTime());
        ...
        public override void Down()
        {
            ...
            DropColumn("TMS.Partner", "LastModifiedTime");
            DropColumn("TMS.Partner", "LastModifiedBy");
            DropColumn("TMS.Partner", "CreatedTime");
            DropColumn("TMS.Partner", "CreatedBy");
